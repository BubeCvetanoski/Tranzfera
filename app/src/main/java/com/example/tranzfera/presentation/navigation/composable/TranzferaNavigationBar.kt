...
fun TranzferaNavigationBar(
    ...
    showSnackbarListener: (String) -> Unit
) {
    NavigationBar(
        modifier = Modifier
            .fillMaxWidth(),
        ...
        listOfNavItems.forEach { navItem ->
            NavigationBarItem(
                ...
                onClick = {
                    if (navItem.route == Screens.TransferScreen.name && !isConnectedDevice) {
                        showSnackbarListener("You must connect to a device to access this screen.")
                    } else {
